...
CREATE TABLE tickets ( 
    ...
    status_ticket VARCHAR(50) DEFAULT 'ABERTO' CHECK (status_ticket IN ('ABERTO', 'EM ANÁLISE', 'FECHADO', 'Resolvido')), 
...
CREATE TABLE pedidos ( 
    ...
    status_pedido VARCHAR(20) NOT NULL CHECK (status_pedido IN ('Pendente', 'Pago', 'Cancelado', 'Reembolsado')), 
...
CREATE TABLE logs_auditoria (
    ...
    CONSTRAINT fk_log_admin FOREIGN KEY (admin_uid) REFERENCES utilizadores(discord_uid) ON DELETE RESTRICT
);
